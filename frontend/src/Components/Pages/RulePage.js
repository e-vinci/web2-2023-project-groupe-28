...
const Rulepage = () => {
    ...
    main.innerHTML = `
    <div id="rules" class="card w-72 mx-auto my-8 bg-base-100 text-primary-content p-4">
        <div class="card-body">
            <img src="../../img/wireframe_img/logo.png"/>
            <h1 class="card-title text-4xl">Rules</h1>
            ...
            <h3 class="text-2xl">Taking Turns :</h3>
            ...
            <h3 class="text-2xl">Special Rules :</h3>
